...
int Read_IGRF_Model(char  mdfile[PATH],
                    double &minyr,
                    double &maxyr,
...
{ /*  Variable declaration  */
  ...
  //  Obtain the desired model file and read the data  */
      ...
      warn_P = 0;
        ...
        strcpy(mdfile,"IGRF11.COF");
        if(! Read_IGRF_Model(mdfile,minyr,maxyr,modelI,nmodel,yrmax,altmin,
        ...
        //        printf("\nEnter the decimal date (%4.2f to %4.0f): ",minyr, maxyr);
                  //Marques
          //sdate = 2003.28073249619;
           sdate = julday(month,day,year);
           sdate += (hour + min/60+sec/3600)/24;
        //}
        ...
        if (decdeg==1)
        {
              ...
              //marques
              //latitude = 47.06190556;
             // latitude = 44.51998611;

              //printf("\n\nEnter the decimal longitude (-180 to 180) (- for Western hemisphere).\n");
              //marques

              //longitude = 19.68752778;
             // longitude = 11.64683056;
        } /* if (decdeg==1) */
