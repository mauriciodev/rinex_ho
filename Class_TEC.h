...
class Class_TEC
{
	public:
        ...
        void Pierce_Point_Coord( double Xest,double Yest,double Zest,
         ...
         long double Calc_STEC_PR(double P1,double P2,int prn);

         double Mean_Phase_Code(double ph1, double ph2, double p1, double p2,
         ...
         long double Calc_STEC_PH_PR(double ph1, double ph2,double p1,double p2,double Mean_Diff_Li_Pi,int prn);
